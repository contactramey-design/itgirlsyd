...
function BusinessHubPage({ onBack }) {
  const [isVisible, setIsVisible] = useState(false);
  ...
  const businessServices = [
    ...
    },
    {
      ...
      url: 'mailto:sydney@itgirlsydcontent.com?subject=MODA Investment Inquiry'
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {businessServices.map((service, index) => (
            <a
              ...
              rel="noopener noreferrer"
              className={`group bg-gradient-to-br from-gray-900 to-black border-2 border-green-500/30 rounded-xl p-6 hover:border-green-400 transition-all duration-300 hover:-translate-y-2 shadow-lg ${service.glowColor}`}
            >
              {/* Service icon */}
              <div className="relative mb-4">
...
export default function CreatorLandingPage() {
  ...
  if (currentPage === 'business') {
    return <BusinessHubPage onBack={navigateHome} />;
  }
