      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        {activeCategory === 'physical' && (
          <>
            ...
            <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 rounded-2xl p-8 mb-12 text-white text-center shadow-xl">
              <div className="flex items-center justify-center gap-3 mb-3">
                <Sparkles className="w-8 h-8 text-yellow-300 animate-pulse" />
                <h3 className="text-2xl font-bold">Exclusive IT GIRL Merch</h3>
                <Sparkles className="w-8 h-8 text-yellow-300 animate-pulse" />
              </div>
              <p className="text-pink-100 max-w-xl mx-auto">
                Shop our signature collection! More styles coming soon 💖
              </p>
            </div>
